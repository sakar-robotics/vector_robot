...
// Motor Mapping Array
MotorConfig motors[] = {
  {MCPWM_UNIT_0, MCPWM_TIMER_0, MCPWM_OPR_A, Config::MOTOR_DRIVER_PINS[0].dir},  // Motor 1
  {MCPWM_UNIT_0, MCPWM_TIMER_0, MCPWM_OPR_B, Config::MOTOR_DRIVER_PINS[1].dir},  // Motor 2
  {MCPWM_UNIT_1, MCPWM_TIMER_1, MCPWM_OPR_A, Config::MOTOR_DRIVER_PINS[2].dir},  // Motor 3
  {MCPWM_UNIT_1, MCPWM_TIMER_1, MCPWM_OPR_B, Config::MOTOR_DRIVER_PINS[3].dir},  // Motor 4
};
...
void motorSetSpeed(uint8_t motor, int8_t speed)
{
  ...
  // Logging: output the target direction and PWM duty value
  Serial.print("motorSetSpeed: motor=");
  Serial.print(motor);
  Serial.print(", dir_pin=");
  Serial.print(m.dir_pin);
  Serial.print(", direction set to=");
  Serial.print(speed > 0 ? "HIGH" : "LOW");
